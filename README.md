...
A full-stack **MERN** doctor appointment system built with **React (Vite), Tailwind CSS, Node.js, MongoDB, Cloudinary, and Razorpay**. This platform allows patients to book appointments with doctors, manage their schedules, and make secure online payments. Admins can oversee the entire system efficiently.
...
Once both frontend and backend are running, access the app at:
```
http://localhost:5173
```
